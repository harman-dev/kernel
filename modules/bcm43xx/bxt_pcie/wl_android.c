...
#define CMD_WIFI_LOG_LEVEL "DHD_LOG_LEVEL"
...
#define PRIVATE_COMMAND_DEF_LEN	4096
	...
	} else if (strnicmp(command, CMD_WIFI_LOG_LEVEL, strlen(CMD_WIFI_LOG_LEVEL)) == 0) {
                char *log_level = command + strlen(CMD_WIFI_LOG_LEVEL) + 1;
                sscanf(log_level,"%x", &dhd_msg_level);        
