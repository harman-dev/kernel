...
TRACE_EVENT(pstate_sample,
	...
	TP_printk("Pa=%lu iobusy=%lu Pc=%lu mperf=%llu aperf=%llu tsc=%lu ",
			(unsigned long)__entry->av_pstate,
			(unsigned long)__entry->io_busy,
			(unsigned long)__entry->state,
			(unsigned long long)__entry->mperf,
			(unsigned long long)__entry->aperf,
			(unsigned long)__entry->tsc
			)
