...
/** Auto deep sleep */
int auto_ds = MLAN_INIT_PARA_DISABLED;

/** IEEE PS mode */
int ps_mode = MLAN_INIT_PARA_DISABLED;
...
int pcie_int_mode = PCIE_INT_MODE_LEGACY;
...
MODULE_PARM_DESC(pcie_int_mode, "0: Legacy mode");
