...
{
	.name = "Dirana Chime Cp Pin",
	.ops = &skl_pcm_dai_ops,
	.capture = {
		.stream_name = "Dirana Chime Capture",
		.channels_min = HDA_MONO,
		.channels_max = HDA_8_CH,
		.rates = SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_16000 |
			SNDRV_PCM_RATE_22050  | SNDRV_PCM_RATE_32000 |
...
{
	.name = "Dirana Sxm Cp Pin",
	.ops = &skl_pcm_dai_ops,
	.capture = {
		.stream_name = "Dirana Sxm Capture",
		.channels_min = HDA_MONO,
		.channels_max = HDA_8_CH,
		.rates = SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_16000 |
			SNDRV_PCM_RATE_22050  | SNDRV_PCM_RATE_32000 |
...
{
	.name = "Modem Dupl Cp Pin",
	.ops = &skl_pcm_dai_ops,
	.capture = {
		.stream_name = "Modem PT Dupl Capture",
		.channels_min = HDA_8_CH,
		.channels_max = HDA_8_CH,
		.rates = SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S32_LE,
...
{
	.name = "Dirana Mic1 Cp Pin",
	.ops = &skl_pcm_dai_ops,
	.capture = {
		.stream_name = "Dirana Mic1 Capture",
		.channels_min = HDA_MONO,
		.channels_max = HDA_8_CH,
		.rates = SNDRV_PCM_RATE_48000,
		.formats = SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S32_LE,
...
static int skl_platform_soc_probe(struct snd_soc_platform *platform)
{
	...
	/* if there is no always-on CLK allow the system to go suspend */
	if (!clk_cnt) {
