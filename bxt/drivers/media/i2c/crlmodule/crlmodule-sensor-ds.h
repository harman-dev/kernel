...
#define CRL_REG_LEN_MASK                        0x07
#define CRL_REG_ADDR_LEN_08BIT                  0x00
#define CRL_REG_ADDR_LEN_16BIT                  0x08
#define CRL_REG_ADDR_LEN_MASK                   0x08
#define CRL_REG_READ_AND_UPDATE                 (1 << 5)
#define CRL_REG_LEN_READ_MASK                   0x0f
#else
...
typedef int (*sensor_specific_read)(struct i2c_client *);
...
struct crl_sensor_configuration {
	...
	sensor_specific_init custom_sensor_init;
	sensor_specific_cleanup custom_sensor_cleanup;
	sensor_specific_init sensor_init;
	sensor_specific_cleanup sensor_cleanup;
	sensor_specific_read sensor_status_read;
	/*
