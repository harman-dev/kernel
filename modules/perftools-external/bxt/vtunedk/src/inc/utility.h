...
#define SYS_Write_MSR(msr,val)       wrmsr_safe(msr,(unsigned long)(val&0xFFFFFFFFLL), (unsigned long)(val>>32))
#else
#define SYS_Write_MSR(msr,val)       wrmsr((U32)msr, (unsigned long)(val&0xFFFFFFFFLL), (unsigned long)(val>>32))
#endif
#endif

#if defined(DRV_EM64T)
#if defined(DRV_DEBUG_MSR)
#define SYS_Write_MSR(msr,val)       wrmsr_safe((U32)msr,(U32)((U64)(val)),(U32)((U64)(val) >> 32))
#else
#define SYS_Write_MSR(msr,val)       wrmsrl((U32)msr,val)
#endif
#endif
