...
#define PWRBTN_LVL1_IRQ		(1 << 0)
#define TMU_LVL1_IRQ		(1 << 1)
#define THRM_LVL1_IRQ		(1 << 2)
#define BCU_LVL1_IRQ		(1 << 3)
#define ADC_LVL1_IRQ		(1 << 4)
#define CHGR_LVL1_IRQ		(1 << 5)
#define GPIO_LVL1_IRQ		(1 << 6)
#define CRIT_LVL1_IRQ		(1 << 7)
#define LVL1_IRQ_DEF_MASK	0xff
...
static const struct regmap_irq bxtwc_regmap_irqs_level2[] = {
	...
	REGMAP_IRQ_REG(BXTWC_BCU_IRQ, 3, 0x07),
	REGMAP_IRQ_REG(BXTWC_ADC_IRQ, 4, 0xff),
	REGMAP_IRQ_REG(BXTWC_USBC_IRQ, 5, 0x20),
	REGMAP_IRQ_REG(BXTWC_CHRG_BC12_IRQ, 5, 0x10),
	REGMAP_IRQ_REG(BXTWC_EXT_I2C_IRQ, 5, 0x0e),
	REGMAP_IRQ_REG(BXTWC_EXT_CHRG_IRQ, 5, 0x01),
	REGMAP_IRQ_REG(BXTWC_VBUS_DET_IRQ, 6, 0x01),
	REGMAP_IRQ_REG(BXTWC_PWR_DET_IRQ, 6, 0x1b),
...
static struct wcove_bcu_platform_data bxtwc_bcu_data = {
	.config = {
		{VWARN1_CFG_REG,	0xFE},	/* 3.1V */
		{VWARN2_CFG_REG,	0xFB},	/* 3.3V */
		{VCRIT_CFG_REG,		0xFB},	/* 2.9V */
		{ICCMAXVCC_CFG_REG,	0x06},
		{ICCMAXVNN_CFG_REG,	0x06},
		{ICCMAXVSYS_CFG_REG,	0x00},
		{BCUDISW2_BEH_REG,	0x03},
...
static struct resource pmic_i2c_resources[] = {
	DEFINE_RES_IRQ_NAMED(BXTWC_EXT_I2C_IRQ, "I2C"),
	DEFINE_RES_IRQ_NAMED(BXTWC_EXT_CHRG_IRQ, "CHARGER"),
};

static struct resource usbc_resources[] = {
	DEFINE_RES_IRQ_NAMED(BXTWC_USBC_IRQ, "USBC"),
	DEFINE_RES_IRQ_NAMED(BXTWC_VBUS_DET_IRQ, "VBUSDET"),
 };

static struct resource extcon_resources[] = {
	DEFINE_RES_IRQ_NAMED(BXTWC_CHRG_BC12_IRQ, "EXTCON0"),
	DEFINE_RES_IRQ_NAMED(BXTWC_PWR_DET_IRQ, "EXTCON1"),
};
...
static struct mfd_cell bxt_wc_dev[] = {
	...
	{
		.name = "bxt_wcove_extcon",
		.num_resources = ARRAY_SIZE(extcon_resources),
		.resources = extcon_resources,
	},
	{
		.name = "bxt_wcove_pmic_i2c",
	...
	},
	{
		...
		.platform_data = &bxtwc_bcu_data,
		.pdata_size = sizeof(bxtwc_bcu_data),
	},
	{
		.name = "bxt_wcove_gpio",
...
static int bxtwc_probe(struct platform_device *pdev)
{
	...
	/* Unmask 1st level interrupts */
	regmap_write(pmic->regmap, BXTWC_MIRQLVL1, 0x0);
...
MODULE_AUTHOR("ramakrishna.pallala@intel.com");
