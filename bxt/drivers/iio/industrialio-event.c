...
/**
 * iio_event_wait() - wait for the event to occur.
 * It is a Blocking call.
 */
unsigned int iio_event_wait(struct iio_dev *indio_dev)
{
	struct iio_event_interface *ev_int = indio_dev->event_interface;
	...
	ret_val = wait_event_interruptible(ev_int->wait,
