...
#define HCI_PULSAR_RESET_COMPLETE		0x04

#define HCI_COMMAND_COMPLETE_EVENT		0x0E
#define HCI_COMMAND_HARDWARE_ERROR		0x10
#define HCI_VS_ASYNC_EVENT			0xFF
#define HCI_FATAL_EXCEPTION			0xFF
#define HCI_DEBUG_EXCEPTION			0xFF
/* BOOT_UP event */
#define HCI_INTEL_BOOTUP_EVENT_ID		0x02
#define HCI_INTEL_BOOTUP_REASON_HW_RESET	0x00
#define HCI_INTEL_BOOTUP_REASON_HCI_RESET	0x01
...
#define HCI_INTEL_BOOTUP_REASON_UNKNW_RESET	0xFF

/*Secure send command result */
#define HCI_INTEL_SECURE_SEND_CMD_RESULT_ID	0x06
#define HCI_INTEL_SECURE_SEND_CMD_RES_SUCCESS   0x00
