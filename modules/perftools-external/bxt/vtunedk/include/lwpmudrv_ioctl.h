...
#define LWPMUDRV_IOCTL_GET_SAMPLE_DROP_INFO         LWPMUDRV_CTL_READ_CODE(DRV_OPERATION_GET_SAMPLE_DROP_INFO)
#define LWPMUDRV_IOCTL_GET_DRV_SETUP_INFO           LWPMUDRV_CTL_READ_CODE(DRV_OPERATION_GET_DRV_SETUP_INFO)
#define LWPMUDRV_IOCTL_GET_PLATFORM_TOPOLOGY        LWPMUDRV_CTL_READ_CODE(DRV_OPERATION_GET_PLATFORM_TOPOLOGY)
...
#define LWPMUDRV_IOCTL_GET_PLATFORM_INFO             70
...
#define LWPMUDRV_IOCTL_SET_DEVICE_NUM_UNITS          78 //82  //SR: check for duplicate -was 78 now 82
#define LWPMUDRV_IOCTL_TIMER_TRIGGER_READ            79
#define LWPMUDRV_IOCTL_GET_INTERVAL_COUNTS           80//83
#define LWPMUDRV_IOCTL_FLUSH                         81 //84
#define LWPMUDRV_IOCTL_SET_SCAN_UNCORE_TOPOLOGY_INFO 82//80
#define LWPMUDRV_IOCTL_GET_UNCORE_TOPOLOGY           83//81
#define LWPMUDRV_IOCTL_GET_MARKER_ID                 84//85
#define LWPMUDRV_IOCTL_GET_SAMPLE_DROP_INFO          85
#define LWPMUDRV_IOCTL_GET_DRV_SETUP_INFO            86
#define LWPMUDRV_IOCTL_GET_PLATFORM_TOPOLOGY         87
...
#define LWPMUDRV_IOCTL_COMPAT_GET_SAMPLE_DROP_INFO   _IOR(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_SAMPLE_DROP_INFO, compat_uptr_t)
#define LWPMUDRV_IOCTL_COMPAT_GET_DRV_SETUP_INFO     _IOR(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_DRV_SETUP_INFO, compat_uptr_t)
#define LWPMUDRV_IOCTL_COMPAT_GET_PLATFORM_TOPOLOGY  _IOR(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_PLATFORM_TOPOLOGY, compat_uptr_t)
#endif
...
#define LWPMUDRV_IOCTL_GET_SAMPLE_DROP_INFO   _IOR(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_SAMPLE_DROP_INFO, IOCTL_ARGS)
#define LWPMUDRV_IOCTL_GET_DRV_SETUP_INFO     _IOR(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_DRV_SETUP_INFO, IOCTL_ARGS)
#define LWPMUDRV_IOCTL_GET_PLATFORM_TOPOLOGY  _IOR(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_PLATFORM_TOPOLOGY, IOCTL_ARGS)
...
#define LWPMUDRV_IOCTL_GET_PLATFORM_TOPOLOGY  _IOW(LWPMU_IOC_MAGIC, DRV_OPERATION_GET_PLATFORM_TOPOLOGY, IOCTL_ARGS_NODE)
...
#define LWPMUDRV_IOCTL_GET_PLATFORM_TOPOLOGY  DRV_OPERATION_GET_PLATFORM_TOPOLOGY
