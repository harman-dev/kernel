...
static const char *extcon_name[] =  {
	...
	[EXTCON_CHG_ACA_DOCK]		= "ACA-DOCK",
	[EXTCON_CHG_SE1]		= "SE1-CHARGER",
	[EXTCON_CHG_MHL]		= "MHL-CHARGER",
	[EXTCON_CHG_DC]			= "DC-CHARGER",

	/* USB Type-C connector */
	[EXTCON_TYPEC_SNK]		= "TYPEC-SNK",
	[EXTCON_TYPEC_SRC]		= "TYPEC-SRC",
	[EXTCON_TYPEC_DP_SRC]		= "TYPEC-DP-SOURCE",
...
static int find_cable_id_by_name(struct extcon_dev *edev, const char *name)
{
	...
	while (i < EXTCON_NUM) {
		if (extcon_name[i] &&
		    !strncmp(extcon_name[i], name, CABLE_NAME_MAX)) {
			id = i;
			break;
		}
		i++;
