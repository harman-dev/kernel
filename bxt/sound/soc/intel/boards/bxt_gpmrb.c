...
static const struct snd_soc_dapm_route broxton_gpmrb_map[] = {
		...
		{ "dirana_chime_in", NULL, "ssp2 Rx"},
		{ "ssp2 Rx", NULL, "DiranaCp"},

		{ "dirana_sxm_in", NULL, "ssp2 Rx"},
		{ "ssp2 Rx", NULL, "DiranaCp"},
		...
		{ "Modem_ssp3_dupl_in", NULL, "ssp3 Rx"},
		{ "ssp3 Rx", NULL, "ModemDl"},

		{ "ModemUl", NULL, "ssp3 Tx"},
		{ "ssp3 Tx", NULL, "Modem_ssp3_out"},

		{ "dirana_mic1_in", NULL, "ssp3 Rx"},
		{ "ssp3 Rx", NULL, "Mic1Cp"},
};
...
static struct snd_soc_dai_link broxton_gpmrb_dais[] = {
		...
		{
				.name = "Modem Dupl Cp Port",
				.stream_name = "Modem Dupl Cp",
				.cpu_dai_name = "Modem Dupl Cp Pin",
				.codec_name = "snd-soc-dummy",
				.codec_dai_name = "snd-soc-dummy-dai",
				.platform_name = "0000:00:0e.0",
				.init = NULL,
		...
		{
				.name = "Dirana Chime Cp Port",
				.stream_name = "Dirana Chime Cp",
				.cpu_dai_name = "Dirana Chime Cp Pin",
				.codec_name = "snd-soc-dummy",
				.codec_dai_name = "snd-soc-dummy-dai",
				.platform_name = "0000:00:0e.0",
				.init = NULL,
		...
		},
		{
				...
				.stream_name = "Dirana Sxm Cp",
				.cpu_dai_name = "Dirana Sxm Cp Pin",
				.codec_name = "snd-soc-dummy",
				.codec_dai_name = "snd-soc-dummy-dai",
				.platform_name = "0000:00:0e.0",
				.init = NULL,
		...
		},
		{
				...
				.stream_name = "Dirana Mic1 Cp",
				.cpu_dai_name = "Dirana Mic1 Cp Pin",
				.codec_name = "snd-soc-dummy",
				.codec_dai_name = "snd-soc-dummy-dai",
				.platform_name = "0000:00:0e.0",
				.init = NULL,
